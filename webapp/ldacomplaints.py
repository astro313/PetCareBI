...
def lda_analysis(list_of_tokenized_text, num_topics=5):
    ...
    dictionary.filter_extremes(no_above=0.95, keep_n=100000)
...
def get_topics_distributions_per_biz(list_of_tokenized_text, lda_model):
    """
    ...
    df_123 = pd.DataFrame(dominant_topics, columns=['Document_Id', 'Dominant_Topic'])
...
def plot_topics_distribution_per_biz(df):
    ...
    plt.set_title('Number of Documents by Dominant Topic',
